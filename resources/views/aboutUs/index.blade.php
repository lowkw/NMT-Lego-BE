...
<section class="title-banner">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" style="margin: 2rem;">
        <div class="bg-white p-4 rounded-lg shadow-md profileCard-aboutUs">
            <img class="img-fluid rounded-circle mx-auto" src="http://localhost/images/default-profile-image.jpg" width="80%" alt="Profile Image">
        ...
        <div class="bg-white p-4 rounded-lg shadow-md profileCard-aboutUs">
            ...
            <div class="text-left mt-3">
                ...
                <b>Last Name:</b> Neoh<br>
                <b>LinkedIn: </b> <a href="https://www.linkedin.com/in/rowanneoh/" target="_blank">LinkedIn Profile</a>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow-md profileCard-aboutUs">
            ...
            <div class="text-left mt-3">
                ...
                <b>LinkedIn:</b> <a href="https://au.linkedin.com/in/kok-wei-low" target="_blank">LinkedIn Profile</a>
            </div>
        </div>
