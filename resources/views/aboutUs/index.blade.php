...
<section class="title-banner">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" style="margin: 2rem;">
        <div class="bg-white p-4 rounded-lg shadow-md profileCard-aboutUs">
            <img class="img-fluid rounded-circle mx-auto" src="http://localhost/images/profile/cameron-photo.jpg" width="100%" alt="Profile Image">
            <div class="text-left mt-3">
                ...
                <img class="img-fluid mx-auto" src="http://localhost/images/profile/QR-Cameron.png" width="70%" alt="Profile Image">

            </div>
        </div>

        <div class="bg-white p-4 rounded-lg shadow-md profileCard-aboutUs">
            <img class="img-fluid rounded-circle mx-auto" src="http://localhost/images/profile/rowan-neoh.jpg" width="95%" alt="Profile Image">
            <div class="text-left mt-3">
                ...
                <img class="img-fluid mx-auto" src="http://localhost/images/profile/QR-Rowan.png" width="70%" alt="Profile Image">
            </div>
        </div>

        <div class="bg-white p-4 rounded-lg shadow-md profileCard-aboutUs">
            <img class="img-fluid rounded-circle mx-auto" src="http://localhost/images/profile/kokweilow.jpg" width="100%" alt="Profile Image">
            <div class="text-left mt-3">
                ...
                <img class="img-fluid mx-auto" src="http://localhost/images/profile/QR-kokWei.png" width="70%" alt="Profile Image">
            </div>
        </div>

        <div class="bg-white p-4 rounded-lg shadow-md profileCard-aboutUs">
            <img class="img-fluid rounded-circle mx-auto" src="http://localhost/images/default-profile-image.jpg" width="100%" alt="Profile Image">
            <div class="text-left mt-3">
